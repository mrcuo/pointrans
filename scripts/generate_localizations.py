...
ZH = {
    ...
    "Explain in this sentence": "解释这个词在句子里的意思",
    ...
    "Pointrans is explaining this sentence": "Pointrans 正在解释这句话",
    "Pointrans is ready. Try it here.": "Pointrans 已经可以用了，在这里试一次。",
    ...
    "The blue action at the bottom of the real card completes the experience.": "点击真实翻译卡底部的蓝色操作即可完成体验。",
    ...
    "This is the real Pointrans interaction—not a simulated result. The translation card will appear beside your pointer.": "这里使用的就是 Pointrans 日常交互，不是模拟结果。翻译卡会直接出现在光标旁。",
    ...
    "Translation is ready — release Left Option": "翻译已出现，请松开左 Option",
    ...
    "Click “Explain in this sentence” in the card": "点击翻译卡里的“解释这个词在句子里的意思”",
    "Continue in the translation card": "请在翻译卡中继续",
    "Done — keep using the result card.": "完成了，结果卡可以继续使用。",
    "Hold still for a moment": "保持光标不动片刻",
    "Keep the pointer still until the real translation card appears.": "保持光标不动，直到真实翻译卡出现。",
    "Move back to the blue word and repeat the same gesture.": "把光标移回蓝色单词，再做一次相同操作。",
    "No other action is needed. The real result will stay open when setup finishes.": "现在无需进行其他操作。设置结束后，真实结果仍会保持打开。",
    "Point to the blue word and hold Left Option": "把光标指向蓝色单词，按住左 Option",
    "Reading the blue word…": "正在读取蓝色单词…",
    "Setup will close automatically; your real result stays open.": "设置窗口会自动关闭，真实结果卡会继续保留。",
    "The real translation card is beside your pointer.": "真实翻译卡就在光标旁。",
    "The result card shows one clear recovery action. Follow it there; your translation is preserved.": "翻译卡里会显示唯一的恢复操作；按提示操作即可，已有翻译不会丢失。",
    "The setup window closes automatically after the real explanation appears.": "真实解释出现后，设置窗口会自动关闭。",
    "The translation will appear beside your pointer, just like normal use.": "翻译会像日常使用一样直接出现在光标旁。",
}
